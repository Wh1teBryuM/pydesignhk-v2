...
function TrackerTab({ adminToken }) {
  ...
  async function fetchProjects() {
    ...
    setError("")
    try {
      const res  = await fetch("https://pydesignhk-backend.onrender.com/tracker/admin/projects", { headers: { authorization: adminToken } })
  ...
  async function handleCreateProject() {
    ...
    try {
      ...
      const res  = await fetch("https://pydesignhk-backend.onrender.com/tracker/admin/projects", {
        method:  "POST",
  ...
  async function handleSavePhase() {
    ...
    setSavingPhase(true)
    try {
      const res  = await fetch(`https://pydesignhk-backend.onrender.com/tracker/admin/phases/${editingPhase.id}`, {
        method:  "PATCH",
        headers: { authorization: adminToken, "Content-Type": "application/json" },
        body: JSON.stringify({
  ...
  async function handleAddUpdate() {
    ...
    try {
      const res  = await fetch(`https://pydesignhk-backend.onrender.com/tracker/admin/phases/${selectedPhase.id}/updates`, {
        method:  "POST",
        headers: { authorization: adminToken, "Content-Type": "application/json" },
      ...
      for (let i = 0; i < updatePhotos.length; i++) {
        ...
        await fetch(`https://pydesignhk-backend.onrender.com/tracker/admin/updates/${updateId}/photos`, {
          method:  "POST",
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={async (e) => {
                      ...
                      await fetch(`https://pydesignhk-backend.onrender.com/tracker/admin/projects/${proj.id}`, {
                        method: "PATCH",
...
export default function AdminDashboard() {
  ...
  async function fetchInquiries() {
    ...
    try {
      const token = localStorage.getItem("adminToken")
      const res   = await fetch("https://pydesignhk-backend.onrender.com/admin/inquiries", {
  ...
  async function handleLogout() {
    const token = localStorage.getItem("adminToken")
    await fetch("https://pydesignhk-backend.onrender.com/admin/logout", {
      method:  "POST",
      headers: { authorization: token },
    })
